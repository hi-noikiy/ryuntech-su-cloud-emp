package com.ryuntech.common.utils.redis;
...
public class JedisUtil {
    ...
    // default: NX -- Only set the key if it does not already exist.
    ...
    /**
     * SET if Not eXists, 即当key不存在时，才会去设置value值，设置成功返回1，否则返回0
     *
     * @param key
     * @param value
     * @return
    ...
    public boolean setnx(String key, String value, long time) {
        return setnx(key, value, EX, time);
    }

    public boolean setnx(String key, String value, String expx, long time) {
        Jedis jedis = getResource();
