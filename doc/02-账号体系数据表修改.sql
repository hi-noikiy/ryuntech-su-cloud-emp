...
CREATE TABLE `ryn_company` (
  `COMPANY_ID` VARCHAR (64) CHARACTER SET UTF8MB4 COLLATE UTF8MB4_BIN NOT NULL COMMENT '主键',
  `NAME` VARCHAR (127) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '公司名称',
  `LOGO` VARCHAR (127) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '公司LOGO',
  `INDUSTRY_TYPE` TINYINT (1) NOT NULL DEFAULT '0' COMMENT '行业类别ID',
  ...
  `POSTAL_CODE` VARCHAR (10) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '邮编',
  `TEL` VARCHAR (11) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '电话',
  `FAX` VARCHAR (50) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '传真',
  `CONTACTOR` VARCHAR (64) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '联系人',
  `EMPLOYEE_ID` VARCHAR (64) CHARACTER SET UTF8MB4 COLLATE UTF8MB4_BIN NOT NULL COMMENT '负责人员工ID',
  `POSITION` VARCHAR (64) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '职位',
  `PHONE` VARCHAR (11) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '手机号',
  `QQ` VARCHAR (15) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT 'QQ',
  `EMAIL` VARCHAR (127) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '邮箱',
  `COMPANY_WEB` VARCHAR (255) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '公司网址',
  `COMPANY_INTRODUCE` VARCHAR (255) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '公司介绍',
  `TAXPAYER_IDENTIFY_NUM` VARCHAR (64) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '纳税人识别号',
  `INVOICE_PAYABLE` VARCHAR (127) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '发票抬头',
  `INVOICE_ADDRESS` VARCHAR (255) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '（发票）地址',
  `INVOICE_TEL` VARCHAR (20) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '（发票）电话',
  `INVOICE_OPEN_NAME` VARCHAR (127) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '（发票）开户名称',
  `INVOICE_OPEN_BANK` VARCHAR (60) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '（发票）开户银行',
  `INVOICE_BANK_ACCOUNT` VARCHAR (50) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '（发票）银行账号',
  `HOTLINE_TEL` VARCHAR (11) COLLATE UTF8MB4_UNICODE_CI NOT NULL DEFAULT '' COMMENT '服务热线',
