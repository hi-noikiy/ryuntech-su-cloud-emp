  ...
  <div class="app-container">
    ...
    <el-card style="margin-top: 20px">
      <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row>
        <el-table-column align="center" label="部门名称" width="500">
          <template slot-scope="scope">
            {{ scope.row.id }}
          </template>
        </el-table-column>
        <el-table-column align="center" label="新增销售额" width="300">
          <template slot-scope="scope">
            {{ scope.row.username }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="应收余额" width="300" align="center">
          <template slot-scope="scope">
            {{ scope.row.phone }}
          </template>
        </el-table-column>
        <el-table-column label="回款余额" align="center">
          <template slot-scope="scope">
